...
long long  const DCU_id   =        210600402900;              // y.f. 25/12/22 add meter id in constant flash code
uint32_t firmware_date          BSP_PLACE_IN_SECTION(".wmp_manufacture_date*") = 0x230301;                // y.f. 27/12/22 add frimware manufacture date
uint32_t CurrentFirmwareVersion BSP_PLACE_IN_SECTION(".wmp_firmware_version*") = 101;
